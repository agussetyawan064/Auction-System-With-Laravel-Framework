...
@section('side_bar')
  ...
  <ul class="sidebar-menu">
    <!-- Optionally, you can add icons to the links -->
    <li><a href="{{url('/user_members')}}"><img src="../img/u.svg" width="20px" height="20px"> <span>File Upload</span></a></li>
  </ul>
@endsection
              ...
              @foreach($cruds as $crud)
                <tr class="item{{$crud->idperusahaan}}">
                  ...
                  <td>
                    ...
                    <button class="delete-modal btn btn-danger btn-sm" data-idperusahaan="{{$crud->idperusahaan}}">Delete</button>
                  </td>
                </tr>
              @endforeach
            </table>
